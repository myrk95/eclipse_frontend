    ...
    <nav className="navbar">
      ...
      <ul className="navbar-menu">
        <li className="nav-item">
          <Link to="/" className={location.pathname === "/" ? "nav-link active" : "nav-link"}>Inicio</Link>
        </li>
        <li className="nav-item">
          <Link to="/scanner" className={location.pathname === "/scanner" ? "nav-link active" : "nav-link"}>Escáner</Link>
        </li>
        <li className="nav-item">
          <Link to="/history" className={location.pathname === "/history" ? "nav-link active" : "nav-link"}>Historial</Link>
        </li>
        <li className="nav-item">
          <Link to="/about" className={location.pathname === "/about" ? "nav-link active" : "nav-link"}>Acerca de</Link>
        </li>
      </ul>
